...
def detect_lang(name):
    n = name.lower()
    blocked = ["telugu", "malayalam", "kannada", "hindi", "marathi", "gujarati", "bengali", "punjabi", "odia", "urdu", "maa ", "gemini", "flowers", "asianet", "udaya", "suvarna", "etv ", "zee telugu", "zee kannada", "star maa"]
    if any(lang in n for lang in blocked): return "other"
